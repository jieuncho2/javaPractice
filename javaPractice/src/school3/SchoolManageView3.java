...
public class SchoolManageView3 {
	public static void main(String[] args) {
		...
		StudentManage3 manage = StudentManage3.getInstance();
		...
		while(true) {
			...
			case 1: 
				...
				StudentManage3.addStudent();
				break;
			case 2: 
				System.out.println("학생 삭제 메뉴입니다.");
				StudentManage3.removeStudent();
				break;
			case 3: 
				System.out.println("수강 신청 메뉴입니다.");
				StudentManage3.addClass();
				break;
			case 4: 
				System.out.println("성적 입력 메뉴입니다.");
				StudentManage3.setScore();
				break;
			case 5: 
				System.out.println("정보 조회 메뉴입니다.");
				StudentManage3.informStudent();
				break;
			case 6: 
